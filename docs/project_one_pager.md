...
| **Metrics** | ⭐⭐⭐⭐ | RAG Recall@5=0.96 · cross_doc=1.00 · MRR=0.67 · pytest 37/37 · doctor 10 OK（auto-load `.env.local`）· verify_pipeline 6/6 · verify_docs all green · 多 Persona 回归（自评：评估集 50 题为小规模，扣 1 星） |
