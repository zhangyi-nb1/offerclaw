...
```text
=== OfferClaw RAG 评估 v2 (K=5, N=50, DB=118 chunks) ===
...
```json
{
  "status": "healthy",
  "chroma_db": "connected",
  "collection_records": 118,
  "timestamp": "2026-04-26 02:47:03"
}
```

`GET /api/info`（11 路由清单证明）：
```json
{
  "name": "OfferClaw API",
  "version": "1.1.0",
